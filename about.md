...
✨ Hi there! I’m **Ruolin Su**, an M.S. student at **DM-Lab-ECNU**, East China Normal University (ECNU), advised by Prof. **Junjie Yao**. I received my Bachelor’s degree from Hefei University of Technology, ranking **5/159** in my major.

My research interests lie in **large language model reasoning, retrieval-augmented generation (RAG), and LLM applications**. I am currently working on **agentic Graph RAG** and **knowledge-fusion RAG** to build reliable and interpretable AI systems.
